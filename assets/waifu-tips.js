...
// 后端接口
live2d_settings['modelAPI']             = '//live2d.mytime.ink/';   // 自建 API 修改这里
...
//看板娘样式设置
live2d_settings['waifuSize']            = '200x170';    // 看板娘大小，例如 '280x250', '600x535'
live2d_settings['waifuTipsSize']        = '170x50';     // 提示框大小，例如 '250x70', '570x150'
